...
function replacementFor(finding) {
  ...
  return `systems/thewitchertrpg/assets/images/generated/${category}/${slug}.webp`;
}
...
async function ensureGeneratedAsset(foundryPath, finding) {
  ...
  try {
    ...
    throw new Error(`Missing curated replacement image for ${finding.documentName}: ${filePath}`);
  }
}
